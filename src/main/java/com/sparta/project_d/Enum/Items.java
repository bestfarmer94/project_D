...
public enum Items {
    ...
    하급_융화재료("하급 오레하 융화 재료", Category.융화),
    중급_융화재료("중급 오레하 융화 재료", Category.융화),
    상급_융화재료("상급 오레하 융화 재료", Category.융화),
    최상급_융화재료("최상급 오레하 융화 재료", Category.융화);

    private final String itemName;
    private final Category category;

    Items(String itemName, Category category) {
